require(data.table)
annotation <- fread('/media/general/projects/NCI_60_phospho/Final_dataset/MQ1.5.5.1_NCI60_FP_complete/txt/proteinGroups.txt', stringsAsFactors = F, integer64 = 'double')
...
saveRDS(annotation, '/media/msdata5/users_files/martin/postdoc/projects/phosphoproject/dat/preproc/nci60_fp_annotation.rds', compress = T)
