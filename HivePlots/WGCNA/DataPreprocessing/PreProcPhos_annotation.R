require(data.table)
annotation <- fread('/media/general/projects/NCI_60_phospho/Final_dataset/MQ1.5.5.1_pNCI60_pCRC65_complete/txt/Phospho (STY)Sites.txt', stringsAsFactors = F, integer64 = 'double')
...
saveRDS(annotation, '/media/msdata5/users_files/martin/postdoc/projects/phosphoproject/dat/preproc/crc65_psites_annotation.rds', compress = T)