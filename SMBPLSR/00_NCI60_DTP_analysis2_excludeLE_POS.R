...
vp <- concord(X, y, kx = cho.kx, ky = cho.ky, option = "nk", ncomp = 40,
              scan = FALSE, ncores = 5, maxiter = 10000,
              dmod = 1, center.x = TRUE, scale.x = TRUE,
              center.y = TRUE, scale.y = TRUE, pos = TRUE)
...
saveWorkbook(wb, "Res/20170915_concordResSummary/concord-c40-pos.xlsx", overwrite = TRUE)
